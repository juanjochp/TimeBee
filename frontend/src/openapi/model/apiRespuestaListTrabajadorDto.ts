 ...
 */
export interface ApiRespuestaListTrabajadorDto { 
    data?: Array<TrabajadorDto>;
    estado?: ApiRespuestaListTrabajadorDto.EstadoEnum;
}
export namespace ApiRespuestaListTrabajadorDto {
